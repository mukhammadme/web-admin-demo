...
INSERT INTO users (username, password, enabled) values ('user', '{bcrypt}$2a$10$gpE7WF/3gLqt30FVAoijDenibfHUAkVcNmDavK9Qw.LxF5lR0OrL6', true);
INSERT INTO users (username, password, enabled) values ('admin', '{bcrypt}$2a$10$gpE7WF/3gLqt30FVAoijDenibfHUAkVcNmDavK9Qw.LxF5lR0OrL6', true);
